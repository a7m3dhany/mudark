...
@app.on_message(
    filters.command(["مميزات","مميزات دارك"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس دارك ميوزك\n
⩹━★⊷⌯⌞ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐷𝐴𝑅𝐾 🖤 ⌝⌯⊶★━⩺

★قايمه مميزات سورس دارك 
