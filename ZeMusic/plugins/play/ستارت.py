...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/D2_RK) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/D2_RK) /ZE \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/D2_RK)\n [𝑆𝑂𝑈𝑅𝐶𝐸 𝐷𝐴𝑅𝐾 🖤](https://t.me/D2_RK)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/D2_RK) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/D2_RK"),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/D2_RK) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/D2_RK) \n ※[These Features AI Based](https://t.me/D2_RK)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="D2_RK"),
                ],
                [                
                    InlineKeyboardButton(" Commands", callback_data="cbcmds"),
                    InlineKeyboardButton(" Donate", url=f"https://t.me/D2_RK"),
                ],
                [
                    InlineKeyboardButton(
                        " DEVELOPER ", url="https://t.me/A7_M3"
                    )
                ],
            ]
        ),
...
@Client.on_callback_query(filters.regex("D2_RK"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""🔱 **※Welcome \n
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع دارك من هن : @D2_RK **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
